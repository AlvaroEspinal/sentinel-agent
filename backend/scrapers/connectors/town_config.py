...
TARGET_TOWNS: Dict[str, TownConfig] = {
    ...
    "wellesley": TownConfig(
        ...
        permit_portal_url="https://www.wellesleyma.gov/197/Inspectional-Services",
        permit_portal_type="firecrawl",
    ...
    "weston": TownConfig(
        ...
        permit_portal_url="https://www.westonma.gov/298/Building-Department",
        permit_portal_type="firecrawl",
    ...
    "brookline": TownConfig(
        ...
        permit_portal_url="https://www.brooklinema.gov/168/Building-Department",
        permit_portal_type="firecrawl",
    ...
    "needham": TownConfig(
        ...
        permit_portal_url="https://www.needhamma.gov/196/Building-Department",
        permit_portal_type="firecrawl",
    ...
    "natick": TownConfig(
        ...
        permit_portal_url="https://www.natickma.gov/283/Building-Department",
        permit_portal_type="firecrawl",
    ...
    "concord": TownConfig(
        ...
        permit_portal_url="https://concordma.gov/581/Building-Inspections",
        permit_portal_type="firecrawl",
    ...
    "lexington": TownConfig(
        ...
        permit_portal_url="https://www.lexingtonma.gov/building",
        permit_portal_type="firecrawl",
